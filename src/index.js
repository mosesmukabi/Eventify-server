...
import { createEvent, fetchSingleEvent, fetchAllEvents, getUserEvents, deleteEvent, updateEvent, getUserProfile, joinEvent, getJoinedEvents, cancelEvent, getJoinedEvent, getJoinedEventParticipants  } from './controllers/events.js';
...
app.get("/user/joined-events", verifyToken, getJoinedEvent);
app.get("/users/joined-event", verifyToken, getJoinedEventParticipants);
